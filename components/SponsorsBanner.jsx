...
export default function SponsorsBanner() {
  return (
    <div className="flex flex-col gap-4 w-full max-w-[850px] mx-auto p-4 box-border font-sans">
      
      {/* --- FILA SUPERIOR: FIANCOR Y VITALE --- */}
      <div className="flex flex-col md:flex-row gap-4 w-full">
        ...
        <div className="flex-1 bg-white rounded-lg p-4 pr-[140px] relative flex flex-col justify-center min-h-[110px] border-2 border-[#2B4E8C] items-start shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          ...
          <div className="absolute bottom-3 right-4 flex gap-3">
            ...
            <a href="hhttps://www.facebook.com/vitalenegociosinmobiliarios/" target="_blank" rel="noopener noreferrer" className="text-gray-400 text-lg transition-all duration-200 hover:scale-110 hover:text-[#2B4E8C]" title="Facebook">
              <i className="fa-brands fa-facebook"></i>
            </a>
      ...
      {/* --- FILA INFERIOR: BANNER NEW IRONS --- */}
