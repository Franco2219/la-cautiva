    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative bg-[#fffaf5]">
      <div className={`w-full ${['ranking-view', 'group-phase', 'direct-bracket'].includes(navState.level) ? 'max-w-7xl' : 'max-w-6xl'} mx-auto z-10`}>
        ...
        <div className={`space-y-4 ${['ranking-view', 'group-phase', 'direct-bracket'].includes(navState.level) ? 'w-full' : 'max-w-xl mx-auto'}`}>
          ...
          {/* CUADRO CORREGIDO ESTRUCTURALMENTE */}
                    ...
                    return (
                      <div key={idx} className="relative">
                        <div className="space-y-6">
                          <div className={`border-b-2 ${w1 ? 'border-[#b35a38]' : 'border-slate-300'} pb-1 flex justify-between items-end bg-white h-7 relative`}>
                          ...
                          <div className={`border-b-2 ${w2 ? 'border-[#b35a38]' : 'border-slate-300'} pb-1 flex justify-between items-end bg-white h-7 relative`}>
                        ...
                        {/* Llave vertical que nace exactamente de los bordes inferiores */}
                        <div className="absolute top-[28px] -right-[48px] w-[48px] h-[54px] border-r-2 border-t-2 border-b-2 border-slate-300 z-0" />
                        {/* Línea horizontal central corregida */}
                        <div className="absolute top-[55px] -right-[78px] w-8 h-[2px] bg-slate-300" />
                      </div>
                    )
                  })}
                </div>
                    ...
                    return (
                      <div key={idx} className="relative">
                        <div className="space-y-10">
                          <div className={`border-b-2 ${w1 ? 'border-[#b35a38]' : 'border-slate-300'} pb-1 flex justify-between items-end bg-white h-7`}>
                          ...
                          <div className={`border-b-2 ${w2 ? 'border-[#b35a38]' : 'border-slate-300'} pb-1 flex justify-between items-end bg-white h-7`}>
                        ...
                        <div className="absolute top-[28px] -right-[48px] w-[48px] h-[70px] border-r-2 border-t-2 border-b-2 border-slate-300 z-0" />
                        <div className="absolute top-[63px] -right-[78px] w-8 h-[2px] bg-slate-300" />
                      </div>
                    )
                  })}
                </div>
                ...
                <div className="flex flex-col items-center ml-24 w-80 relative z-10 text-center">
                  <div className="w-full space-y-12 mb-16">
                    {[0, 1].map((idx) => {
                      ...
                      return (
                        <div key={idx} className={`border-b-4 ${win ? 'border-[#b35a38]' : 'border-slate-200'} pb-2 h-10 flex justify-between items-end bg-white`}>
